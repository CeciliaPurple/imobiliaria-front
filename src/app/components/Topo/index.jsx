    ...
    return (
        ...
        >
            ...
            <div className={styles.nav}>
               ...
               {user?.tipo === 'adm' ? <Link href="/agendamento" className={styles.nav_link}>Visitas Agendadas</Link> : <Link href="/visita" className={styles.nav_link}>Agenda de Visitas</Link>}
            </div>
